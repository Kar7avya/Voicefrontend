  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        position: "relative",
        overflow: "hidden",
        backgroundColor: "#FF9933"   // <-- saffron fallback
      }}>
        {/* Logo */}
        <div style={{
          position: "absolute",
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(to top, rgba(255,153,51,0.85) 0%, rgba(255,153,51,0.5) 50%, rgba(255,153,51,0.7) 100%)",
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ... rest of login form remains unchanged ... */}
        </div>
      </div>
